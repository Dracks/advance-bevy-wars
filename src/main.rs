...
use crate::{assets::FileAssets, board::{Board, BoardPlugin, MainBoard}};
...
fn follow_cursor(windows: Query<&Window>,
...
fn setup_cursor(
    ...
    commands.spawn((
        Cursor::default(),
        Sprite::from_atlas_image(cursor_img, TextureAtlas { layout: texture_atlas_layout, index: 1 }),
